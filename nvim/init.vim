...
set foldmethod=syntax        " Keep an eye on this (previous was indent)
...
" Use an undo file
set undofile
set undodir=~/.tmp/nvim/.vimundo/ " set a directory to store the undo history

" Send color escape codes
